...
exports.signup = function(req, res){
   ...
   if(req.method == "POST"){
      ...
      var sql = "INSERT INTO `users`(`first_name`,`last_name`,`mob_no`,`user_name`, `password`) VALUES ('" + 
        fname + "','" + lname + "','" + mob + "','" + name + "',password('" + pass + "'))";
   ...
   if(req.method == "POST"){
      ...
      db.query(sql, function(err, results){      
         if(results && results.length){
            ...
            message = 'User name or password incorrect, please enter again!';
...
exports.uploadvideo=function(req,res){
    ...
    display_upload_file_html(res, res);
 };
 

 exports.myvideo=function(req,res){
    var userId = req.session.userId;
    if(userId == null){
       res.redirect("/login");
       return;
